class T2stock < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/franpfeiffer/t2stock/releases/download/v1.0.0/t2stock_1.0.2_darwin_amd64.tar.gz"
      sha256 "b58cdd29b12752557316ca6b554d8a02d9b6619a4342ab80e1a28209fe7d68be"
    end
    if Hardware::CPU.arm?
      url "https://github.com/franpfeiffer/t2stock/releases/download/v1.0.0/t2stock_1.0.2_darwin_arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/franpfeiffer/t2stock/releases/download/v1.0.0/t2stock_1.0.2_linux_amd64.tar.gz"
      sha256 "18c5de65e473d31eb39070b6eb6ece1763782ddc06663b3df9f47c44bbe3d1d6"
    end
    if Hardware::CPU.arm? && Hardware::CPU.arch_64_bit?
      url "https://github.com/franpfeiffer/t2stock/releases/download/v1.0.0/t2stock_1.0.2_linux_arm64.tar.gz"
